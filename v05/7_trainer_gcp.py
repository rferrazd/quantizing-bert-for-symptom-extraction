...
V05 training entrypoint for GCP. Loads the symptom-ner-dataset-v05 from Hugging Face,
...
Identical hyperparameters to V04 — only the dataset changes (P1/P2/P3 fixes).
"""
...
if __name__ == "__main__":
    ...
    # using the same v04 hyperparameters to train v05
